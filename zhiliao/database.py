...
class Database(object):
    ...
    def submit(self, token, pred: detect_debug.PredictRes):
        ...
        request_eval_time = submit_time - self.req_eval_range
        select_num = int(submit_interval_milisec / self.req_submit_interval_milisec) + 1
    ...
    def get_tired_score(self,token):
        ...
        score = (yawn_time / 0.5 + sleep_time / 0.2) / drive_time_milisec / 100 * drive_time_factor
